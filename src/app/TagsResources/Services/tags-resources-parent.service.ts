      ...
      parser.parseString(data, function (err, result) {
        ...
        for (k in obj.Item) {
          ...
          arr.push({
            id: k,
            title: item.title[0],
            imageName: item.imageName[0],
            imageLink: `${environment.HostUrl}/${item.imageLink[0]}`,
            text: item.text[0],
            textLink: item.textLink[0],
          });
        }
        resolve(arr);
      });
  ...
  getRandomImage(catName?: string) {
    switch (catName) {
      case 'Love-Romance':
        this.imageUrl =
          LovaRomanceImages[
            Math.floor(Math.random() * LovaRomanceImages.length)
          ];
        break;
      case 'Dating-Courtship':
        this.imageUrl =
          DatingCourtship[Math.floor(Math.random() * DatingCourtship.length)];
        break;
      case 'Abbreviations-Acronyms':
        this.imageUrl =
          AbbreviationsAcronyms[
            Math.floor(Math.random() * AbbreviationsAcronyms.length)
          ];
        break;
      case 'Activity-Partner':
        this.imageUrl =
          ActivityPartner[Math.floor(Math.random() * ActivityPartner.length)];
        break;
      case 'Astrology-Horoscope':
        this.imageUrl =
          AstrologyHoroscope[
            Math.floor(Math.random() * AstrologyHoroscope.length)
          ];
        break;
      case 'Attraction-Crushes':
        this.imageUrl =
          AttractionCrushes[
            Math.floor(Math.random() * AttractionCrushes.length)
          ];
        break;
      case 'Business-Partner':
        this.imageUrl =
          BusinessPartner[Math.floor(Math.random() * BusinessPartner.length)];
        break;
      case 'Career-Opportunities':
        this.imageUrl =
          CareerOpportunities[
            Math.floor(Math.random() * CareerOpportunities.length)
          ];
        break;
      case 'Chemistry-Connection':
        this.imageUrl =
          ChemistryConnection[
            Math.floor(Math.random() * ChemistryConnection.length)
          ];
        break;
      case 'extras-extras':
      ...
      case 'Flirting-Seducing':
        this.imageUrl =
          FlirtingSeducing[Math.floor(Math.random() * FlirtingSeducing.length)];
        break;
      case 'Friends-Acquaintances':
        this.imageUrl =
          FriendsAcquaintances[
            Math.floor(Math.random() * FriendsAcquaintances.length)
          ];
        break;
      case 'Gays-Lesbians':
        this.imageUrl =
          GaysLesbians[Math.floor(Math.random() * GaysLesbians.length)];
        break;
      case 'Harmony-Compatibility':
        this.imageUrl =
          HarmonyCompatibility[
            Math.floor(Math.random() * HarmonyCompatibility.length)
          ];
        break;
      case 'Heartbreaks-Breakups':
        this.imageUrl =
          HeartbreaksBreakups[
            Math.floor(Math.random() * HeartbreaksBreakups.length)
          ];
        break;
      ...
      case 'Hookups-Affairs':
        this.imageUrl =
          HookupsAffairs[Math.floor(Math.random() * HookupsAffairs.length)];
        break;
      ...
      case 'Infidelity-Cheating':
        this.imageUrl =
          InfidelityCheating[
            Math.floor(Math.random() * InfidelityCheating.length)
          ];
        break;
      case 'Just-Friends':
        this.imageUrl =
          JustFriends[Math.floor(Math.random() * JustFriends.length)];
        break;
      case 'life-style':
      ...
      case 'Long-Relationship':
        this.imageUrl =
          LongRelationship[Math.floor(Math.random() * LongRelationship.length)];
        break;
      case 'Marriage-Wedding':
        this.imageUrl =
          MarriageWedding[Math.floor(Math.random() * MarriageWedding.length)];
        break;
      case 'Open-Relationship':
        this.imageUrl =
          OpenRelationship[Math.floor(Math.random() * OpenRelationship.length)];
        break;
      case 'Quotes-Sayings':
        this.imageUrl =
      ...
      case 'Relationship-Commitment':
        this.imageUrl =
          RelationshipCommitment[
            Math.floor(Math.random() * RelationshipCommitment.length)
          ];
        break;
      case 'Sex-Intimacy':
        this.imageUrl =
          SexIntimacy[Math.floor(Math.random() * SexIntimacy.length)];
        break;
      case 'Short-Relationship':
        this.imageUrl =
          ShortRelationship[
            Math.floor(Math.random() * ShortRelationship.length)
          ];
        break;
      case 'Singles-Unattached':
        this.imageUrl =
          SinglesUnattached[
            Math.floor(Math.random() * SinglesUnattached.length)
          ];
        break;
      case 'Virtual-Relationship':
        this.imageUrl =
          VirtualRelationship[
            Math.floor(Math.random() * VirtualRelationship.length)
          ];
        break;
    }
