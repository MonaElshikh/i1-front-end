...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  SetMetaTags() {
    this.metaTags = [
      ...
      {
        name: 'description',
        content: 'Use this form to login to your account at ispace1',
      },
    ];
  ...
  async sendPw(frm: NgForm) {
    ...
    this.subscribtion = (await this.authService.GetUserByEmail(data)).subscribe(
      (result: any) => {
  ...
  SetEmailObject(): appEmail {
    this.HTML =
      '<tr><td colspan=\'2\' style="padding-top :5px;padding-left :5px;font-size: 12px;font-family: Verdana;color: #666666;"> We have received your request to retrieve your login information with us. ' +
      '<br />' +
      '</td></tr>';
    this.HTML +=
      '<tr><td colspan=\'2\' style="padding-top :5px;padding-left :5px;font-size: 12px;font-family: Verdana;color: #666666;"> Following is your login information: ' +
      '<br />' +
      '</td></tr>';
    this.HTML +=
      '<tr><td colspan=\'2\' style="padding-top :5px;padding-left :5px;font-size: 12px;font-family: Verdana;color: #666666;"> Username: <b>' +
      this.registerData.userId +
      '</b><br/></td></tr>';
    this.HTML +=
      '<tr><td colspan=\'2\' style="padding-top :5px;padding-left :5px;font-size: 12px;font-family: Verdana;color: #666666;"> Password: <b>' +
      this.registerData.password +
      '</b><br/><br/></td></tr>';
    this.HTML +=
      "<tr><td colspan='2' style=\"padding-top :5px;padding-left :5px;font-size: 12px;font-family: Verdana;color: #666666;\"> <a style='text-decoration:none' href=http://www.ispaceone.com/Login>Please click here to login to your account.</a></b><br/><br/></td></tr>";
